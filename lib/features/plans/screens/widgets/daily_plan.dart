  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return MRoundedContainer(
        isGradient: paymentController.showDailyPlan.value,
        ...
        child: Column(
          children: [
            MPlanTile(
              onTap: () {
                paymentController.showDailyPlan.value =
                !paymentController.showDailyPlan.value;
              },
              up: paymentController.showDailyPlan.value,
              title: 'Daily Plan',
            ),
            if (paymentController.showDailyPlan.value)
              Column(
                children: [
